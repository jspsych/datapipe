...
export const DOCS_NAV = [
  {
    // Ungrouped, first -- a release announcement, not a member of "Overview".
    // Existing researchers land here from the homepage modal
    // (components/WhatsChangedModal.js) or the pointer atop /docs, and it has
    // to be the first thing the sidebar shows them, the same way the ungrouped
    // "About DataPipe" / "Citing DataPipe" pair sits apart at the end (see the
    // comment on that entry below) rather than folded into a themed group.
    group: null,
    pages: [
      {
        href: "/docs/whats-changed",
        label: "What's changed",
        sections: [
          { id: "changes-that-can-affect-your-code", label: "Changes that can affect your code" },
          { id: "new-places-to-send-data", label: "New places to send data" },
          { id: "saving-data-as-it-runs", label: "Saving data as the experiment runs" },
          { id: "when-an-upload-fails", label: "When an upload fails" },
          { id: "rejected-submissions", label: "Rejected submissions" },
          { id: "psych-ds-metadata", label: "Psych-DS metadata" },
          { id: "finalizing-a-dataset", label: "Finalizing a dataset" },
          { id: "signing-in-and-your-account", label: "Signing in and your account" },
          { id: "privacy-and-data-handling", label: "Privacy and data handling" },
          { id: "a-new-look", label: "A new look" },
  ...
  },
  {
    ...
    pages: [
      ...
      {
        href: "/docs/experiments/streaming",
        label: "Saving as you go",
        sections: [
          { id: "why-save-as-you-go", label: "Why save as you go" },
          { id: "turning-it-on", label: "Turning it on" },
          { id: "what-to-expect", label: "What to expect" },
          { id: "privacy", label: "What it means for privacy" },
    ...
    pages: [
      {
        ...
        sections: [
          ...
          { id: "start-session", label: "Start an incremental session" },
      ...
      },
      {
        ...
        sections: [
          { id: "what-datapipe-is", label: "What DataPipe is" },
          { id: "saving-as-you-go", label: "If it saves as it goes" },
          { id: "what-we-process", label: "What DataPipe processes" },
          { id: "what-we-store", label: "What DataPipe stores" },
          { id: "retention", label: "Retention and deletion" },
          { id: "encryption", label: "Encryption" },
          { id: "who-can-access", label: "Who can reach your data" },
          { id: "what-we-do-not-do", label: "What DataPipe does not do" },
          { id: "what-we-do-not-have", label: "Certifications it does not have" },
          { id: "your-responsibilities", label: "What is yours to decide" },
          { id: "jurisdiction", label: "Where data is processed" },
          { id: "incidents", label: "Security incidents" },
          { id: "for-your-irb", label: "For your IRB protocol" },
          { id: "questions", label: "Questions" },
        ],
      },
    ],
